...
public class RoutingPortController {
	...
	public static void select() {
		...
		try {
			...
			List routingPort = sessionObj.createQuery("FROM packetslogging ").list();
			/*
	...
	public static void update(String router,int port) {
		logger.info("Routing Port Update");
		Session session = RoutingPortController.buildSessionFactory().openSession();
	...
	public static void delete(String router) {
